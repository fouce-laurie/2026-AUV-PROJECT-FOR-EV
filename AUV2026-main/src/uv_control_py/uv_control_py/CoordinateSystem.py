...
class CoordinateSystems:
    def __init__(self):
        self.base = MotionState()               # 机器人当前在世界中的位置和姿态
        self.target_inbase = MotionState()      # 目标点在机器人坐标系中的位置和姿态
        self.target_inworld = MotionState()     # 目标点在世界坐标系中的位置和姿态
