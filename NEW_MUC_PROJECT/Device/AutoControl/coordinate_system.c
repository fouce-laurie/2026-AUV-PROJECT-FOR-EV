...
void matrixInverse(float *input, float *result)
{
    ...
    arm_mat_init_f32(&mat_in, 4, 4, (float *)input);
    arm_mat_init_f32(&mat_out, 4, 4, (float *)result);

    arm_mat_inverse_f32(&mat_in, &mat_out);
}
...
void multiplyMatrix(float *m1, float *m2, float *result)
{
    ...
    arm_mat_init_f32(&mat1, 4, 4, (float *)m1);
    arm_mat_init_f32(&mat2, 4, 4, (float *)m2);
    arm_mat_init_f32(&mat_out, 4, 4, (float *)result);
